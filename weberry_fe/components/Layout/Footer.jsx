...
const Footer = () => {
  return (
    <div className="bg-white fixed w-full bottom-0 z-20 h-20">
      <div className=" mx-auto max-w-5xl px-4 sm:px-6 py-3 border-t-2 border-y-grey border-opacity-50">
        <div className="place-content-evenly flex ">
          ...
          <Link href="/community">
            <button
              className=" hover:text-light_pink focus:text-light_pink"
              xmlns="http://www.w3.org/2000/svg"
              href="pages/commu/cindex.js">
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                className="w-8 h-8 mt-3 mx-4">
